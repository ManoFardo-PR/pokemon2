...
| Unblocks | [S05.T08](T08-spreadsheet-import.md), [S05.T09](T09-import-attack-effects-json.md), [S05.T10](T10-import-catalog-recipes.md), [S05.T13](T13-rules-editor-ui.md), [S05.T15](T15-rules-export-import-seed.md), [S06.T02](../06-bots/T02-deck-profile-analysis.md), [S08.T06](../08-operations-and-extensions/T06-llm-assisted-authoring.md) |
...
- **Sizing — this file is the longest in the stage and may be two subtasks.** Steps 1–10 define and implement the composition contract; step 11 authors roughly forty starter codes, which is a different kind of work (reading cards, choosing a grain, writing bodies and schemas) and is the thing the three importers actually consume. A split would be "S05.T07 composition semantics" (the contract, `compose.ts`, the API, the lint) and a new subtask "starter code vocabulary" depending on it and unblocking [S05.T08](T08-spreadsheet-import.md)–[S05.T10](T10-import-catalog-recipes.md). Not applied here, because renumbering is not this pass's to do and because the starter vocabulary is what makes the contract concrete enough to review. Proposed for the user's decision.
